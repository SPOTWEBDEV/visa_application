...
<head>
    ...
    <title>Students Visa || <?php echo $sitename?> </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
                    ...
                    <div class="col-xl-4 col-lg-5" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">
                        <div class="visa-details__pages">
                            ...
                            <ul class="list-unstyled visa-details__nav">
                                <li><a href="<?= $domain ?>/business_visa/">Students Visa
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form role="search" method="get" class="search-popup__form" action="<?= $domain ?>/student_visa/#">
    ...
    <aside class="sidebar-three">
        ...
        <div class="sidebar-three__content">
            ...
            <div class="sidebar-three__newsletter sidebar-three__item">
                ...
                <form action="<?= $domain ?>/student_visa/#" class="sidebar-three__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
    ...
    <a href="<?= $domain ?>/student_visa/#" data-target="html" class="scroll-to-target scroll-to-top">
