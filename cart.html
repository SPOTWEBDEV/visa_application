...
<body class="custom-cursor">
            ...
            <div class="container">
                <div class="main-header__inner">
                    <div class="main-header__logo logo-retina">
                        <a href="index.html">
                            <img src="<?php echo $domain ?>/assets/images/logo-dark.png" alt="Visanet HTML" width="230">
                        </a>
                    ...
                    <div class="main-header__right">
                        <nav class="main-header__nav main-menu">
                            <ul class="main-menu__list">
                                                    ...
                                                    <div class="home-showcase__inner">
                                                        <div class="row">
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-1.jpg" alt="visanet">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-2.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-3.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-4.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-5.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-boxed.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                                            ...
                                                            <div class="col-md-6 col-lg-3">
                                                                <div class="demo-one__card">
                                                                    <div class="demo-one__image">
                                                                        <img src="<?php echo $domain ?>/assets/images/visanet-landing/home-rtl.jpg" alt="visanet">
                                                                        <div class="demo-one__btns">
                                ...
                                <li class="dropdown">
                                    <a href="cart.html#">Visa</a>
                                    <ul>
                                        <li class="dropdown">
                                            <a href="cart.html#">Visa grid</a>
                                            <ul>
                                        ...
                                        <li class="dropdown">
                                            <a href="cart.html#">Visa Carousel</a>
                                            <ul>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li class="dropdown">
                                            <a href="cart.html#">Blog grid 01</a>
                                            <ul>
                                        ...
                                        <li class="dropdown">
                                            <a href="cart.html#">Blog grid 02</a>
                                            <ul>
                                        ...
                                        <li class="dropdown">
                                            <a href="cart.html#">Blog carousel</a>
                                            <ul>
                                        ...
                                        <li class="dropdown">
                                            <a href="cart.html#">Blog details</a>
                                            <ul>
                        ...
                        <a href="cart.html#" class="main-header__search search-toggler">
                            <i class="icon-search" aria-hidden="true"></i>
                            <span class="sr-only">Search</span>
                        </a><!-- /.main-header__search -->
                        <a href="contact.html" class="main-header__btn visanet-btn">
                            <span class="visanet-btn__icon-box">
                                <span class="visanet-btn__icon"><span><i class="icon-arrow-right-3"></i></span></span>
                            </span>
                            <span class="visanet-btn__text">Appointment</span>
                        </a><!-- /.visanet-btn -->
                        <div class="sidebar-btn__toggler">
                            <span class="sidebar-btn__toggler__icon"><i class="icon-grid"></i></span>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__content">
                    <h2 class="page-header__title" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">Cart</h2>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="cart-page__table__meta">
                                                <div class="cart-page__table__meta__img">
                                                    <img src="<?php echo $domain ?>/assets/images/products/cart-1-1.png" alt="Organ Meats">
                                                </div>
                                                <h3 class="cart-page__table__meta__title"><a href="product-details.html">Smart
                                                        Chair</a></h3>
                                            </div>
                                        </td>
                                        <td class="cart-page__table__price">$82.00</td>
                                        <td>
                                            <div class="cart-page__table__quantity">
                                                <div class="quantity-box">
                                                    <button type="button" class="quantity-box__btn sub"><i class="icon-down-arrow"></i></button>
                                                    <input type="number" name="quantity" value="0" class="quantity-box__input">
                                                    <button type="button" class="quantity-box__btn add"><i class="icon-up-arrow"></i></button>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="cart-page__table__total">$82.00</td>
                                        <td>
                                            <a href="cart.html" class="cart-page__table__remove"><i class="icon-close"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="cart-page__table__meta">
                                                <div class="cart-page__table__meta__img">
                                                    <img src="<?php echo $domain ?>/assets/images/products/cart-1-2.png" alt="Game Meat">
                                                </div>
                                                <h3 class="cart-page__table__meta__title"><a href="product-details.html">Boss
                                                        Chair</a></h3>
                                            </div>
                                        </td>
                                        <td class="cart-page__table__price">$49.00</td>
                                        <td>
                                            <div class="cart-page__table__quantity">
                                                <div class="quantity-box">
                                                    <button type="button" class="quantity-box__btn sub"><i class="icon-down-arrow"></i></button>
                                        ...
                                        <td class="cart-page__table__total">$49.00</td>
                                        <td>
                                            <a href="cart.html" class="cart-page__table__remove"><i class="icon-close"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="cart-page__table__meta">
                                                <div class="cart-page__table__meta__img">
                                                    <img src="<?php echo $domain ?>/assets/images/products/cart-1-3.png" alt="Game Meat">
                                                </div>
                                                <h3 class="cart-page__table__meta__title"><a href="product-details.html">Sofa
                                                        Chair</a></h3>
                                            </div>
                                        </td>
                                        <td class="cart-page__table__price">$66.00</td>
                                        <td>
                                            <div class="cart-page__table__quantity">
                                                <div class="quantity-box">
                                                    <button type="button" class="quantity-box__btn sub"><i class="icon-down-arrow"></i></button>
                                        ...
                                        <td class="cart-page__table__total">$66.00</td>
                                        <td>
                                            <a href="cart.html" class="cart-page__table__remove"><i class="icon-close"></i></a>
                                        </td>
                                    </tr>
                    ...
                    <div class="row gutter-y-40">
                        <div class="col-xl-6 col-lg-7">
                            <div class="cart-page__coupone">
                                <form action="cart.html#" class="cart-page__coupone__form">
                                    <input type="text" placeholder="Enter Cupon Code" class="cart-cupon__coupone__input">
                                    <button type="submit" class="visanet-btn-two">
                                        Apply Coupon <span class="visanet-btn-two__icon"><i class="icon-arrow-right"></i></span>
                                    </button><!-- /.visanet-btn-two -->
                                </form><!-- /.cart-page__coupone__form -->
                        ...
                        <div class="col-xl-6 col-lg-5">
                            <div class="cart-page__cart-checkout">
                                <ul class="cart-page__cart-total list-unstyled">
                                    <li class="cart-page__cart-total__amount">
                                        <span class="cart-page__cart-checkout__title">Cart Total</span>
                                    </li>
                                    <li class="cart-page__cart-total__amount">
                                        <span class="cart-page__cart-total__amount__title">Cart Subtotal</span>
                                        <span class="cart-page__cart-total__amount__text">$42.00</span>
                                    </li>
                                    <li class="cart-page__cart-total__amount">
                                        <span class="cart-page__cart-total__amount__title">Shipping</span>
                                        <span class="cart-page__cart-total__amount__text">Free</span>
                                    </li>
                                    <li class="cart-page__cart-total__amount">
                                        <span class="cart-page__cart-total__amount__title">Total</span>
                                        <span class="cart-page__cart-total__amount__text">$42.00</span>
                                    </li>
                                </ul>
                                <div class="cart-page__button">
                                    <a href="cart.html" class="visanet-btn-two">
                                        Update <span class="visanet-btn-two__icon"><i class="icon-arrow-right"></i></span>
                                    </a><!-- /.visanet-btn-two -->
                                    <a href="checkout.html" class="visanet-btn-two">
                                        Checkout <span class="visanet-btn-two__icon"><i class="icon-arrow-right"></i></span>
                                    </a><!-- /.visanet-btn-two -->
                                </div><!-- /.cart-page__button -->
                            </div>
                        </div><!-- /.col-xl-6 col-lg-5 -->
                    </div><!-- /.row gutter-y-40 -->
                </div><!-- /.cart-page__bottom -->
            </div><!-- /.container -->
        </section><!-- /.cart-page -->
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form role="search" method="get" class="search-popup__form" action="cart.html#">
    ...
    <aside class="sidebar-three">
        ...
        <div class="sidebar-three__content">
            ...
            <div class="sidebar-three__newsletter sidebar-three__item">
                ...
                <form action="cart.html#" class="sidebar-three__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
