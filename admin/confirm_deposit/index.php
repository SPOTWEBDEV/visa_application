        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="default-ordering" class="table table-hover dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 168.25px;">USER NAME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 173.875px;">AMOUNT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT TYPE: activate to sort column ascending"
                                                            style="width: 127.641px;">PAYMENT METHOD</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT STATUS: activate to sort column ascending"
                                                            style="width: 148.672px;">RECEIPT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">TRANSACTION ID</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">DEPOSITES TIME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">UPDATED TIME </th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $statement = $connection->prepare("SELECT deposits.*, users.username, users.email FROM deposits, users WHERE users.id = deposits.user_id ");
                                                    $statement->execute();
                                                    if ($statement->rowCount() > 0) {
                                                        ...
                                                        while ($user = $statement->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img class="img" data-image="<?= $user['id'] ?>" width="100px" height="100px" style="border-radius: 50%; cursor: pointer;" src="../../uploads/<?= $user['receipt'] ?>" alt="">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button href="#" style="background-color:<?= ($user['status']) === "approved" ? "green" : "red" ?>; padding:4px 7px; border-radius: 10px; color:whitesmoke; border:none;"><?= $user['status'] ?>
                                                                    </button>
                                                                </td>
                                                                ...
                                                                <td class="action">
                                                                    <?php if ($user['status'] == 'pending'): ?>
                                                                        <button class="approve" data-approve="<?= $user['id']  ?>" href="" style=" border-radius: 10px; background-color: green !important; padding: 5px 8px ;  border:none;  cursor: pointer;">approve</button>

                                                                        <br> <br>

                                                                        <!-- decline -->
                                                                        <button data-decline="<?= $user['id']  ?>"  class="decline" href="" style="border-radius: 10px; padding: 5px 8px ; background-color:red;  cursor: pointer;  border:none;">Decline</button>
                                                                    <?php else: ?>
                                                                        <button style="pointer-events: none; border: none; border-radius: 10px; padding: 5px 8px ; color: white; background-color:  <?= ($user['status'] === "approved" ? "green" : "red"); ?>;"> <?= ucfirst($user['status']); ?></button>
                                                                    <?php endif; ?>
                    ...
                    <script>
                        ...
                        document.querySelectorAll('.img').forEach(img => {
                            img.addEventListener('click', async (e) => {
                                e.preventDefault();
                                let userId = e.target.dataset.image

                                try {
                                    const response = await fetch("receipt.php?receipt_id=" + encodeURIComponent(userId));
                    ...
                    <!-- approve deposite script -->
                    <script>
                        document.querySelectorAll('.approve').forEach(button => {
                            button.addEventListener('click', async (event) => {
                                event.preventDefault();
                                approve_id = event.currentTarget.dataset.approve;
                                const row = event.target.closest("tr");
                                try {
                                    const response = await fetch("approve.php?approve_id=" + encodeURIComponent(approve_id))
                                    if (!response.ok) {
                        ...
                        //decline deposit
                            ...
                            button.addEventListener('click', async (event) => {
                                event.preventDefault();
                             const approve_id = event.currentTarget.dataset.decline;
                               
                                try {
                                    const response = await fetch("decline.php?decline_id=" + encodeURIComponent(approve_id))
                                    if (!response.ok) {
                                        throw new Error("responds not found");
                                    }
                ...
                <div class="footer-wrapper">
                    <div class="footer-section f-section-1">
                        <p class="">Copyright © <script>
                            ...
                            </script><a target="_blank" href="/"><?php echo  $sitename ?></a>, All rights
                            reserved.</p>
                    </div>
