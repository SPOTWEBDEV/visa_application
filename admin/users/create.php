            ...
            <div class="layout-px-spacing">
                ...
                <form method="post" id="form">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="" name="ProductName" class="form-control" id=""
                                    placeholder="Product Name" required="" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="">Daily Percent</label>
                                <input type="text" value="" name="DailyPercent" class="form-control" id=""
                                    placeholder="Daily percent" required="" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="">Minimuim Investment</label>
                                <input value="" type="text" name="MinimuimInvestment" class="form-control" id=""
                                    placeholder="min Investment" required="" autocomplete="off">
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                <label for="">Maximuim Investment</label>
                                <input type="text" value="" name="MaximuimInvestment" class="form-control"
                                    placeholder="Max Investment" required="" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-4">
                                <label for="">Monthly Percent</label>
                                <input type="text" value="" name="MonthlyPercent" class="form-control"
                                    placeholder="Monthly Percent" required="" autocomplete="off">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button name="register" type="submit" class="btn btn-primary mt-3">Create product</button>
