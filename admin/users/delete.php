                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="default-ordering" class="table table-hover dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 111.922px;">DAILY PERCENT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT CURRENCY: activate to sort column ascending"
                                                            style="width: 173.875px;">MIN INVEST</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT TYPE: activate to sort column ascending"
                                                            style="width: 127.641px;">MAX INVEST</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT STATUS: activate to sort column ascending"
                                                            style="width: 148.672px;">MONTHLY PERCENT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT STATUS: activate to sort column ascending"
                                                            style="width: 148.672px;">CREATED AT</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $statement = $connection->prepare("SELECT * FROM plans");
                                                    $statement->execute();
                                                    if ($statement->rowCount() > 0) {
                                                        ...
                                                        while ($plans = $statement->fetch()) {
                                                            ...
                                                            <tr>
                                                                <td><?= $count ?></td>
                                                                <td><?= $plans['name'] ?></td>
                                                                <td><?= $plans['daily_percent'] . '%'  ?></td>
                                                                <td><?= '$' . $plans['min_invest'] ?></td>
                                                                <td><?= '$' . $plans['max_invest'] ?></td>
                                                                <td><?= $plans['monthly_percent'] . '%' ?></td>
