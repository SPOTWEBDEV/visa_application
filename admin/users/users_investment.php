                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="default-ordering" class="table table-hover dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 127.641px;">STATUS</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="ACCOUNT STATUS: activate to sort column ascending"
                                                            style="width: 148.672px;">INVESTMENT_DATE</th>
                                                ...
                                                <tbody>
                                                    <?php
                                                    $statement = $connection->prepare("SELECT user_investments.* , users.username , users.email , plans.name  FROM user_investments , users , plans WHERE users.id = user_investments.user_id AND  user_investments.plan_id = plans.id");

                                                    // 
                                                    $statement->execute();
                                                    if ($statement->rowCount() > 0) {
                                                        $count = 0;
                                                        while ($user_investment = $statement->fetch()) {
                                                            $count++; ?>
                                                            <tr>
                                                                <td><?= $count ?></td>
                                                                <td><?= $user_investment['username'] ?></td>
                                                                <td><?= $user_investment['name'] ?></td>
                                                                <td><?= '$' . $user_investment['amount'] ?></td>
                                                                <td><?= $user_investment['status'] ?></td>
                                                                <td><?= $user_investment['created_at'] ?></td>
                                                                </td> 
                                                            </tr>
                                                    <?php }
                                                    }
