            ...
            <div class="layout-px-spacing">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="" name="file_title" class="form-control"
                                    placeholder="Enter ads test" required="" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-4">
                                ...
                                <input type="file" value="" name="file" class="form-control"
                                    placeholder="file" required="" autocomplete="off">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button name="upload_ad" type="submit" class="btn btn-primary mt-3">Create Ads</button>
                ...
                if (isset($_POST['upload_ad'])) {
                    ...
                    if (move_uploaded_file($tmp_name, $target_file)) {
                        ...
                        $stm = $connection->prepare("INSERT INTO ads(title, image_url) VALUES(?, ?);");
                        $stm->execute([$title, $target_file]);
             ...
             function sweatAlert(icon, title, text) {
                ...
                form.addEventListener("submit", async (e)=>{
                    ...
                    try {
                        ...
                        const response = await fetch("./vanidate.php", {
                         method:'POST',
                         body:formData
                        ...
                        if(!response.ok){
                         ...
                         const data = await response.json();
                          if (data.status === "success") {
                            sweatAlert("success", "success", data.message);
                          }else{
                            sweatAlert("error", "error", data.message);
                          }

                        
                    } catch (error) {
                        console.log(error);
                           sweatAlert("error", "error", error.message)
                    }
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="default-ordering" class="table table-hover dataTable no-footer"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0"
                                                    ...
                                                    style="width: 111.922px;">IMAGE</th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="default-ordering" rowspan="1" colspan="1"
                                                    aria-label="ACCOUNT CURRENCY: activate to sort column ascending"
                                                    style="width: 173.875px;">CREATED AT</th>
                                                <th class="sorting" tabindex="0"
                                                    aria-controls="default-ordering" rowspan="1" colspan="1"
                                        ...
                                        <tbody>
                                            <?php
                                            $statement = $connection->prepare("SELECT * FROM ads ORDER  BY created_at DESC");
                                            $statement->execute();
                                            if ($statement->rowCount() > 0) {
                                                $count = 0;
                                                while ($plans = $statement->fetch()) {
                                                    $count++; ?>
                                                    <tr>
                                                        <td><?= $count ?></td>
                                                        <td><?= $plans['title'] ?></td>
                                                        <td>
                                                            <img width="100" style="border-radius: 50%;" src="<?= $plans['image_url']   ?>" alt="">
                                                        </td>
                                                        <td><?= $plans['created_at'] ?> </td>
                                                        <td>
                                                            <button class="btn-delete"
                                                                data-id="<?= $plans['id'] ?>"
                                                                style="text-decoration:none; background-color: green; color: white; padding: 8px 10px; border-radius: 10px; border: none;">
                                                                Delete
                                                            </button>
                                                        </td>
            ...
            <script>
                ...
                document.querySelectorAll('.btn-delete').forEach(button => {
                    button.addEventListener('click', async (e) => {
                        ...
                        try {
                            const response = await fetch("./json.php?delete_id=" + encodeURIComponent(id), {
                                method: "GET"
                            });
                            ...
                            if (data.status === "success") {
                                ...
                                sweatAlert('error', 'Oops', data.message);
                            }

                        } catch (error) {
                            sweatAlert('error', 'Oops', error.message);
                        }
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © <script>
                    ...
                    </script><a target="_blank" href="/"></a>, All rights
                    reserved.</p>
            </div>
        </div>
        <!-- END MAIN CONTAINER -->
