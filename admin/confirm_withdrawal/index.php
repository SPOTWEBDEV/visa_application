                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="default-ordering" class="table table-hover dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            style="width: 148.672px;">BANK/CRYPTO NAME</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">ACCOUNT NUMBER/ WALLET ADDRESS</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">ACCOUNT  NAME/ REFERENCE</th>
                                                        ...
                                                        <th class="sorting" tabindex="0"
                                                            ...
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;"> USER IP ADDRESS</th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                            style="width: 71.6094px;">WITHDRAWAL TIME </th>
                                                        <th class="sorting" tabindex="0"
                                                            aria-controls="default-ordering" rowspan="1" colspan="1"
                                                            aria-label="Action: activate to sort column ascending"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $statement = $connection->prepare("SELECT withdrawals.*, users.username, users.id as user_id, users.status as user_status, users.email FROM withdrawals, users WHERE users.id = withdrawals.user_id ");
                                                    $statement->execute();
                                                    if ($statement->rowCount() > 0) {
                                                        ...
                                                        while ($user = $statement->fetch()) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                  $reference = "USD" . date("YmdHis") . rand(100, 999);
                                                                if (!empty($user['bank_name']) && !empty($user['account_name']) && !empty($user['account_number'])) { ?>
                                                                    ...
                                                                    <td><?= htmlspecialchars($user['account_name']) ?></td>
                                                                     <?php  } else {?>
                                                                    <td><?= htmlspecialchars($user['crypto_name']) ?></td>
                                                                    <td><?= htmlspecialchars($user['crypto_address']) ?></td>
                                                                    <td><?= $reference  ?></td>
                                                                <?php
                                                                }
                                                                ?>
                    ...
                    <script>
                        ...
                        document.querySelectorAll('.approve').forEach(button => {
                            button.addEventListener('click', async (event) => {
                                ...
                                try {
                                    const response = await fetch("approve_withdrawal.php?approve_id=" + encodeURIComponent(approve_id))
                                    if (!response.ok) {
