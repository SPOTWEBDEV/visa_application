...
<head>
    ...
    <title>Countries Details || Visanet  </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__content">
                    <h2 class="page-header__title" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">Countries Details</h2>
                    <ul class="visanet-breadcrumb list-unstyled" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="200">
                        ...
                        <li><span>Our countries</span></li>
                        <li><span>Countries Details</span></li>
                    </ul><!-- /.visanet-breadcrumb list-unstyled -->
                </div><!-- /.page-header__content -->
            </div><!-- /.container -->
        </section><!-- /.page-header -->

        <section class="countries-details section-space">
            <div class="container">
                <div class="countries-details__row row gutter-y-50">
                    <div class="col-xl-4 col-lg-5">
                        <aside class="sidebar-two">
                            <div class="sidebar-two__form sidebar-two__single" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                <form action="countries-details.php#" class="sidebar-two__search">
                                    <input type="text" placeholder="Search...." />
                                    <button type="submit" aria-label="search submit" class="sidebar-two__search__icon">
                                        <i class="icon-search"></i>
                                    </button>
                                </form><!-- /.sidebar-two__search -->
                            </div><!-- /.sidebar-two__form -->
                            <div class="visa-details__pages sidebar-two__single" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                <h3 class="visa-details__pages__title">Visa Category:</h3>
                                <ul class="list-unstyled visa-details__nav">
                                    <li><a href="visa-d-business-visa.php">Family Visa
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                    <li><a href="visa-d-visa-processing.php">Quick Visa Processing
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                    <li><a href="visa-d-immigration-visa.php">Immigration Visa
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                    <li><a href="visa-d-family-visa.php">Family Visa
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                    <li><a href="visa-d-students-visa.php">Students Visa
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                    <li><a href="visa-d-travel-visa.php">Travel Visa
                                            <span class="visa-details__nav__icon"><i class="icon-arrow-right-2"></i></span>
                                        </a>
                                    </li>
                                </ul><!-- /.visa-details__nav -->
                            </div><!-- /.visa-details__pages -->
                            <div class="sidebar-two__contact sidebar-two__single" style="background-image: url(<?php echo $domain ?>/assets/images/resources/sidebar-contact.jpg);" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                <div class="sidebar-two__contact__content">
                                    <h4 class="sidebar-two__contact__title">Courses or institutions that help with visa processes.</h4>
                                    <a href="contact.php" class="visanet-btn">
                                        <span class="visanet-btn__icon-box">
                                            <span class="visanet-btn__icon"><span><i class="icon-arrow-right-3"></i></span></span>
                                        </span>
                                        <span class="visanet-btn__text">Contact Now</span>
                                    </a><!-- /.visanet-btn -->
                                </div><!-- /.sidebar-two__contact__content -->
                            </div><!-- /.sidebar-two__contact -->
                            <button type="button" class="sidebar-two__download sidebar-two__single" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                <span class="sidebar-two__download__content">
                                    <span class="sidebar-two__download__icon"><i class="icon-pdf"></i></span>
                                    <span class="sidebar-two__download__right">
                                        <span class="sidebar-two__download__title">Visa Application Form</span>
                                        <span class="sidebar-two__download__text">20mb</span>
                                    </span><!-- /.sidebar-two__download__right -->
                                </span><!-- /.sidebar-two__download__content -->
                                <span class="sidebar-two__download__icon sidebar-two__download__icon--download"><i class="icon-download"></i></span>
                            </button><!-- /.sidebar-two__download -->
                        </aside><!-- /.sidebar-two -->
                    </div><!-- /.col-xl-4 -->
                    <div class="col-xl-8 col-lg-7">
                        <div class="countries-details__content">
                            <h3 class="countries-details__title" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">United States</h3>
                            <p class="countries-details__text" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">Business visa tailored design, management & support services Business  free text available in the but the majority time you put aside to be in our office. Lorem ipsum dolor sit amet, consectet business agency elit, sed do eiusmod tempor  majority have this best we are solution</p>
                            <div class="countries-details__image" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">
                                <img src="<?php echo $domain ?>/assets/images/countries/countries-d-1-1.jpg" alt="countries details">
                            </div><!-- /.countries-details__image -->
                            <div class="countries-details__feature">
                                <div class="row gutter-y-30">
                                    <div class="col-xl-6 col-lg-12 col-md-6" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                        <div class="countries-details__feature__item">
                                            <span class="countries-details__feature__icon"><i class="icon-passport"></i></span>
                                            <div class="countries-details__feature__content">
                                                <h3 class="countries-details__feature__title">Immigration Visa Resources</h3>
                                            </div><!-- /.countries-details__feature__content -->
                                        </div><!-- /.countries-details__feature__item -->
                                    </div><!-- /.col-xl-6 -->
                                    <div class="col-xl-6 col-lg-12 col-md-6" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="200">
                                        <div class="countries-details__feature__item">
                                            <span class="countries-details__feature__icon"><i class="icon-brainstorming"></i></span>
                                            <div class="countries-details__feature__content">
                                                <h3 class="countries-details__feature__title">Best Consultancy Agency</h3>
                                            </div><!-- /.countries-details__feature__content -->
                                        </div><!-- /.countries-details__feature__item -->
                                    </div><!-- /.col-xl-6 -->
                                </div><!-- /.row -->
                            </div><!-- /.countries-details__feature -->
                            <p class="countries-details__text countries-details__text--2" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300"><span>Ready to fly :</span> Immigration Expert Process Visa For This Countries like <br> Canada, USA, UK, London ,Pakistan Australia, etc.</p><!-- /.countries-details__text -->
                            <div class="countries-details__button" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">
                                <a href="countries.php" class="visanet-btn">
                                    <span class="visanet-btn__icon-box">
                                        <span class="visanet-btn__icon"><span><i class="icon-arrow-right-3"></i></span></span>
                                    </span>
                                    <span class="visanet-btn__text">Read More</span>
                                </a><!-- /.visanet-btn -->
                            </div><!-- /.countries-details__button -->
                            <div class="countries-details__grid">
                                <div class="countries-details__image" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                    <img src="<?php echo $domain ?>/assets/images/countries/countries-d-1-2.jpg" alt="countries details">
                                </div><!-- /.countries-details__image -->
                                <div class="countries-details__list" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="200">
                                    <h3 class="countries-details__list__title">Information about for this visa specific country?</h3>
                                    <ul class="countries-details__list__inner list-unstyled">
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            Experienced & Skilled Team Support.
                                        </li>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.7639 9.62873V16.5338C15.7639 16.7813 15.5609 16.982 15.3119 16.982H2.18281C1.93324 16.982 1.73078 16.7813 1.73078 16.5338V3.42709C1.73078 3.18025 1.93324 2.97892 2.18281 2.97892H10.4468L11.4481 2.22986H2.22102C1.53438 2.22986 0.976562 2.78455 0.976562 3.46591V16.495C0.976562 17.1764 1.53438 17.7311 2.22102 17.7311H15.2737C15.9597 17.7311 16.5181 17.1764 16.5181 16.495V8.62595L15.7639 9.62873Z" />
                                            ...
                                            Strategy Consultants Work Closely.
                                        </li>
                                        <li>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.7639 9.62873V16.5338C15.7639 16.7813 15.5609 16.982 15.3119 16.982H2.18281C1.93324 16.982 1.73078 16.7813 1.73078 16.5338V3.42709C1.73078 3.18025 1.93324 2.97892 2.18281 2.97892H10.4468L11.4481 2.22986H2.22102C1.53438 2.22986 0.976562 2.78455 0.976562 3.46591V16.495C0.976562 17.1764 1.53438 17.7311 2.22102 17.7311H15.2737C15.9597 17.7311 16.5181 17.1764 16.5181 16.495V8.62595L15.7639 9.62873Z" />
                                            ...
                                            Technology is a broad category.
                                        </li>
                                    </ul><!-- /.countries-details__list__inner -->
                                </div><!-- /.countries-details__list -->
                            </div><!-- /.countries-details__grid -->
                            <p class="countries-details__text" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">Business visa tailored design, management & support services Business Details on a country's economy, culture, geography, population, or something else country about this solution for visa service business agency elit, sed do eiusmod tempor  majority have.</p>
                            <p class="countries-details__text" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1300">Visa tailored design, management & support services Business Details on a country's economy, business agency elit, sed do eiusmod tempor majority have.</p>
                        </div><!-- /.countries-details__content -->
                    </div><!-- /.col-xl-8 -->
                </div><!-- /.countries-details__row -->
            </div><!-- /.container -->
        </section><!-- /.countries-details -->
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form role="search" method="get" class="search-popup__form" action="countries-details.php#">
    ...
    <aside class="sidebar-three">
        ...
        <div class="sidebar-three__content">
            ...
            <div class="sidebar-three__newsletter sidebar-three__item">
                ...
                <form action="countries-details.php#" class="sidebar-three__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
    ...
    <a href="countries-details.php#" data-target="html" class="scroll-to-target scroll-to-top">
