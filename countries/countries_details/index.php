...
<head>
    ...
    <title>Countries Details || <?php echo $sitename?> </title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <aside class="sidebar-two">
                            <div class="sidebar-two__form sidebar-two__single" data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1300" data-aos-delay="100">
                                <form action="countries_details/#" class="sidebar-two__search">
...
<?php include "../../include/footer.php" ?>
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form role="search" method="get" class="search-popup__form" action="countries_details/#">
    ...
    <aside class="sidebar-three">
        ...
        <div class="sidebar-three__content">
            ...
            <div class="sidebar-three__newsletter sidebar-three__item">
                ...
                <form action="countries_details/#" class="sidebar-three__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
    ...
    <a href="countries_details/#" data-target="html" class="scroll-to-target scroll-to-top">
