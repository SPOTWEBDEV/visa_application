...
<head>
    ...
    <title>Travel Visa || <?php echo $sitename ?> </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form role="search" method="get" class="search-popup__form" action="<?= $domain ?>/travel_visa/#">
    ...
    <aside class="sidebar-three">
        ...
        <div class="sidebar-three__content">
            ...
            <div class="sidebar-three__newsletter sidebar-three__item">
                ...
                <form action="<?= $domain ?>/travel_visa/#" class="sidebar-three__newsletter__inner mc-form" data-url="MAILCHIMP_FORM_URL">
    ...
    <a href="<?= $domain ?>/travel_visa/#" data-target="html" class="scroll-to-target scroll-to-top">
